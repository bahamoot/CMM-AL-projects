...
plink --noweb --bfile $CMM_GENOTYPING_UPPSALA_PROCESSED_PLINK_BIN_FILE_PREFIX --chr 9 --from-bp 98318925 --to-bp 105545484 --recode --tab --transpose --out $project_out_dir --filter $CMM_GENOTYPING_UPPSALA_CRC_LKG_W_RELATIVES_PHENO 2
###********************************************* set parameters here *****************************************************
