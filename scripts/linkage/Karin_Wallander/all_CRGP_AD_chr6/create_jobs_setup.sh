...
dataset_name="all_CRGP_AD_chr6"
project_out_dir="$MUTATIONS_REPORTS_OUTPUT_DIR/CRCP/all_CRGP_AD_chr6"
project_code="b2011097"
annotated_vcf_tabix="$ANNOTATED_WES294"
sample_infos="$script_dir/all_CRGP_AD_chr6_samples.list"
...
report_regions="6:158721534-163269404"
#call_info="True"
split_chrom=False
#filter_actions="Rare"
