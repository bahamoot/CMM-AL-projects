...
project_out_dir="$MUTATIONS_REPORTS_OUTPUT_DIR/CRCP/all_CRGP_AR_chr18"
project_code="b2011097"
annotated_vcf_tabix="$ANNOTATED_WES294"
sample_infos="$script_dir/all_CRGP_AR_chr18_samples.list"
...
report_regions="18:10143377-22114464"
#call_info="True"
split_chrom=False
#filter_actions="Rare"
