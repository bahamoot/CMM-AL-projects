...
dataset_name="all_CRGP_AR_chrX"
project_out_dir="$MUTATIONS_REPORTS_OUTPUT_DIR/CRCP/all_CRGP_AR_chrX"
project_code="b2011097"
annotated_vcf_tabix="$ANNOTATED_WES294"
sample_infos="$script_dir/all_CRGP_AR_chrX_samples.list"
...
report_regions="X:39493220-46836570"
#call_info="True"
split_chrom=False
#filter_actions="Rare"
