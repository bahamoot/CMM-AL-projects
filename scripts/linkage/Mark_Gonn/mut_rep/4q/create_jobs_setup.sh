...
dataset_name="CRC_polyps"
project_out_dir="$MUTATIONS_REPORTS_OUTPUT_DIR/CRC_polyps/4q"
project_code="b2011097"
annotated_vcf_tabix="$ANNOTATED_WES294"
sample_infos="$script_dir/4q_samples.list"
...
report_regions="4:176644821-182327943"
#call_info="True"
split_chrom=False
#filter_actions="Rare"
