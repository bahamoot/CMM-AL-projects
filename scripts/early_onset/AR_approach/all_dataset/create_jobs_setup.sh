...
anno_cols+=",OAF_BRCS_WT"
anno_cols+=",OAF_BRCS_HET"
anno_cols+=",OAF_BRCS_HOM"
anno_cols+=",OAF_FAMILIAL_CRCS_AF"
anno_cols+=",OAF_FAMILIAL_CRCS_GF"
anno_cols+=",OAF_BRC_CRC_PROSTATE_WT"
anno_cols+=",OAF_BRC_CRC_PROSTATE_HET"
anno_cols+=",OAF_BRC_CRC_PROSTATE_HOM"
anno_cols+=",OAF_EARLYONSET_WT"
anno_cols+=",OAF_EARLYONSET_HET"
anno_cols+=",OAF_EARLYONSET_HOM"
anno_cols+=",OAF_FAMILIAL_CRCS_HET"
anno_cols+=",OAF_FAMILIAL_CRCS_HOM"
anno_cols+=",OAF_FAMILIAL_CRCS_WT"
#split_chrom="True"
#filter_actions="Rare"
