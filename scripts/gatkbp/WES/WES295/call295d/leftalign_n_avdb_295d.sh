...
#input_vcf_gz="/home/jessada/private/projects/CMM/scripts/gatkbp/WES/WES295/call295d/tmp_vcf/input.vcf.gz"
input_vcf_gz="$vcf_dir/WES295d.VQSR.vcf.gz"
output_vcf="$vcf_dir/WES295d.la.avdb.VQSR_PASSED.empty.vcf"
