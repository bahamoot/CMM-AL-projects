...
job_name="TYRCA_piper_VQSR"
project_code="b2016200"
project_out_dir="$GATK_BESTPRACTICE_OUTPUT_DIR/WGS/TYRCA/piper/TYRCA_piper_merge"
...
input_vcf_gz="$tmp_dir/TYRCA_piper_merge_genotyped.vcf.gz"
output_vcf_gz="$vcf_dir/TYRCA.VQSR.vcf.gz"

submit_job_cmd="sbatch"
submit_job_cmd+=" -A $project_code"
submit_job_cmd+=" -p core"
submit_job_cmd+=" -n 2"
submit_job_cmd+=" -t 2-00:00:00"
