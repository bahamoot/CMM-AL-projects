...
anno_excl_tags="CRC_101,CRC_CAFAM,CRC_Colon,CRC_Rectal,ILL_BR,Mutstat_details,LJB_score,ExAC_Other,Unknown"
#anno_excl_tags="Axeq_chr3_6_14_18,Axeq_chr5_19,CRC_101,CRC_CAFAM,CRC_Colon,CRC_Rectal,ILL_BR,Mutstat_details,LJB_score,ExAC_Other,Unknown"
#filter_actions="Rare"
#filter_actions+=",Non-Intergenic"
#filter_actions+=",Non-Intronic"
#filter_actions+=",Has-Mutation"
#filter_actions+=",Has-Shared"
annotated_vcf_tabix="/glob/jessada/private/master_data/CMM/table_annovar/onco_array_gw/onco_array_annotated.vcf.gz"
