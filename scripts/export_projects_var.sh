...
export CMM_SCILIFE_ILLUMINA_ALL_PATIENTS_MANS_GZ="$CMM_SCILIFE_ILLUMINA_SEQUENCE_ROOT_DIR/vcf/Ill_Br_Fam242.vcf.gz"
...
export CMM_FAMILY_DATA_ILL_BR_DIR="$CMM_FAMILY_DATA_DIR/Ill_Br/"
export CMM_PATIENT_LIST_ILL_BR="$CMM_FAMILY_DATA_ILL_BR_DIR/Ill_Br.lst"
