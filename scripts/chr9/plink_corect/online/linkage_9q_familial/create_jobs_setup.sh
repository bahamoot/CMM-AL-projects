...
project_out_dir="$PLINK_OUTPUT_DIR/chr9/online/linkage_9q_corect_n_twin_familial"
...
phenotype_file="$GENOTYPING_ONCOCHIP_N_TWINGENE_9Q_LINKAGE_FAMILIAL_PHENOTYPE_FILE"
