...
export MUTATIONS_REPORTS_RUNNING_KEY=$dataset_name
...
cache_dir="$out_dir/cache/9_104030000_104060000"
export MUTATIONS_REPORTS_CACHE_DIR="$cache_dir"

## vcf region from rs10124153 to rs7040414
export MUTATIONS_REPORTS_VCF_REGION="9:104030000-104060000"
