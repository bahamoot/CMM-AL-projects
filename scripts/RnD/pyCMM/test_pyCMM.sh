...
project_name="RnD"
sub_project_name="pyCMM-vcf2avdb"
...
create_directory_structure "$project_out_dir"

#pyCMM-vcf2avdb -i ia -o ob --debug
pyCMM-vcf2avdb -i ia -o "$project_out_dir/out/myout.out" --debug -l "$project_out_dir/log/$running_key"
###********************************************* set parameters here *****************************************************
...
##cache_dir="$project_out_dir/cache/9_139360000_139410000_9_139420000_139440000"
